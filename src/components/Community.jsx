        ...
        <section id="community" className="py-20">
            <div className="container mx-auto px-4">
                <div className="grid lg:grid-cols-2 gap-16">
                    {/* Rules & KYC */}
                    <div>
                        <h2 className="text-3xl md:text-4xl font-black mb-8 font-['Luckiest_Guy'] tracking-tight italic uppercase">
                        ...
                        <div className="mt-8 font-['Cinzel']">
                            <Link to="/rules">
                                <Button className="font-black" variant="glass">{t.read_full}</Button>
                            </Link>
                        </div>
                    </div>
                    ...
                    {/* Events - Green Board */}
                    <div id="events">
                        <h2 className="text-5xl font-black mb-8 font-['Luckiest_Guy'] tracking-tight italic uppercase">
                            {t.events_title_prefix} <span className="text-green-500">{t.events_title_highlight}</span>
                        </h2>
                        ...
                        <div className="relative p-4 bg-[#1a472a] rounded-xl border-[12px] border-[#5c3a21] shadow-2xl transform rotate-1 hover:rotate-0 transition-transform duration-500">
                            ...
                            <div className="h-[400px] flex flex-col items-center justify-center p-6 border border-white/10 text-center">
                                <h3 className="text-4xl text-white/90 font-black mb-6 font-['Luckiest_Guy'] tracking-widest italic" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.5)' }}>
                                    {t.offline_meetups}
                                </h3>

                                <div className="space-y-6 w-full font-['Playfair_Display'] italic">
                                    <div className="border-b border-white/20 pb-2">
                                        <p className="text-bhambola-gold text-2xl font-black">{t.event1.name}</p>
                                        <p className="text-white/60 text-sm font-medium">{t.event1.time}</p>
                                    </div>
                                    <div className="border-b border-white/20 pb-2">
                                        <p className="text-bhambola-gold text-2xl font-black">{t.event2.name}</p>
                                        <p className="text-white/60 text-sm font-medium">{t.event2.time}</p>
                                    </div>
                                    <div>
                                        <p className="text-white/40 font-medium text-lg">{t.more_coming}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
